...
<div class="tbl_head01 tbl_wrap" id="book_tbl_wrap">
...
$( '.next-month' ).on( 'click', function() {
	...
	document.location.href = "./book_config_all.php?s_idx="+sidx+"&ym="+ym;
});
...
function chgym() {
	...
	var sidx = "<?php echo $s_idx;?>";
	document.location.href = "./book_config_all.php?s_idx="+sidx+"&ym="+go_ym;
}
</script>
<script>
