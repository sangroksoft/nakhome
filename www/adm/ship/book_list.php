...
$sql_search = " where (1) and s_idx = '{$s_idx}' " ;
$sop = 'and';
...
<div class="list-top-wrap">
	<div class="cate-wrap">
		<a href="./ship_write.php?w=u&s_idx=<?php echo $s_idx;?>" class="">어선정보</a>
		<a href="./book_config.php?s_idx=<?php echo $s_idx;?>"  class="">예약설정</a>
		<a href="./book_list.php?s_idx=<?php echo $s_idx;?>"  class="selected">예약현황</a>
	</div>
</div>
