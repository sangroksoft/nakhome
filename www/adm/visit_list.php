...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="xs-hidden"><?php echo $link ?><?php echo $title ?><?php echo $link2 ?></td>
        <td class="td_category td_category1 xs-hidden"><?php echo $brow ?></td>
        <td class="td_category td_category3 xs-hidden"><?php echo $os ?></td>
        <td class="td_category td_category2 xs-hidden"><?php echo $device; ?></td>
