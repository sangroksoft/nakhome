...
<div class="local_sch local_sch01">
    ...
    <select name="sfl" id="sch_sort" class="search_sort">
        ...
        <option class="xs-hidden" value="vi_referer"<?php echo get_selected($sfl, 'vi_referer'); ?>>접속경로</option>
...
<div class="tbl_wrap tbl_head01">
    ...
    <tr>
        <th scope="col">IP</th>
        <th scope="col" class="xs-hidden">접속 경로</th>
        <th scope="col" class="xs-hidden">브라우저</th>
        <th scope="col" class="xs-hidden">OS</th>
        <th scope="col" class="xs-hidden">접속기기</th>
        <th scope="col">일시</th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="xs-hidden"><?php echo $link.$title; ?></a></td>
        <td class="td_idsmall td_category1 xs-hidden"><?php echo $brow; ?></td>
        <td class="td_idsmall td_category3 xs-hidden"><?php echo $os; ?></td>
        <td class="td_idsmall td_category2 xs-hidden"><?php echo $device; ?></td>
