...
if($("#divwrap").outerWidth()<991){$(".lsh-toggle-fluid").removeClass("container").addClass("container-fluid");}else{$(".lsh-toggle-fluid").removeClass("container-fluid").addClass("container");}

/*
if($("#divwrap").outerWidth()<1200){$("#grid-container").css("width","100%");}
else {$("#grid-container").css("width","1100px");}
*/
