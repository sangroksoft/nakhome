...
?>
<style>
form input{width:600px;display:block;}
</style>
<form name="fapi" id="fapi" method="post" autocomplete="off">
<input type="text" id="isSuccess" name="isSuccess" value="<?php echo $isSuccess;?>">
<input type="text" id="sccnt" name="sccnt" value="">
<input type="text" id="basey" name="basey" value="">
<input type="text" id="basem" name="basem" value="">
<input type="text" id="based" name="based" value="">
<input type="text" id="basetimestr" name="basetimestr" value="">
<input type="text" id="fc0" name="fc0" value="">
<input type="text" id="fc1" name="fc1" value="">
<input type="text" id="fc2" name="fc2" value="">
<input type="text" id="fc3" name="fc3" value="">
<input type="text" id="fc4" name="fc4" value="">
<input type="text" id="fc5" name="fc5" value="">
<input type="text" id="fc6" name="fc6" value="">
<input type="text" id="fc7" name="fc7" value="">
<input type="text" id="fc8" name="fc8" value="">
<input type="text" id="fc9" name="fc9" value="">
<input type="text" id="fc10" name="fc10" value="">
<input type="text" id="fc11" name="fc11" value="">
<input type="text" id="fc12" name="fc12" value="">
<input type="text" id="fc13" name="fc13" value="">
<input type="text" id="fc14" name="fc14" value="">
<input type="text" id="fc15" name="fc15" value="">
<input type="text" id="fc16" name="fc16" value="">
<input type="text" id="fc17" name="fc17" value="">
<input type="text" id="fc18" name="fc18" value="">
</form>
